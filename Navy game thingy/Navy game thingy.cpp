            ...
            if (ht == false) {
                ...
                if (input2 == 0) {
                    ...
                    if (ht2 == false) {
                        ...
                        Sleep(2000);
                        cout << "아군 순양함의 레이더가 적 대함 미사일 8발을 탐지했습니다. 30초 후 착탄합니다.\n";
                        Sleep(4000);
                        ...
                        if (granithit1 == true) {
                            ...
                            Sleep(8000);
                            if (granithit2 == true) {
                                cout << "시스패로우 미사일이 미사일 4발을 격추했습니다.\n";
                                
                                cout << "채프를 발사하고 팰렁스로 나머지 대함미사일 격추를 시도합니다.\n";
                                Sleep(4000);
                                bool granithit3;
                                granithit3 = hr_third;
                                if (granithit3 == true) {
...
void ticonderoga_main() {
    ...
    Sleep(8000);
    cout << "덴마크 쾨벤하운을 출발한지 4시간이 지났습니다. 더 이상 공군으로부터 항공지원을 받을 수 없습니다. 무선침묵을 끊고 레이더를 가동하시겠습니까? 소련 해군에 발각될 가능성이 증가합니다.\n0을 입력하면 레이더를 가동합니다.\n";
    int tiinput1;
    cin >> tiinput1;
    if (tiinput1 == 0) {
        cout << "AN/SPY-1 레이더를 가동합니다.\n";
        Sleep(4000);
        cout << "레이더가 적 정찰기를 탐지했습니다. 격추할까요?\n0을 입력하면 격추합니다.\n";
        int tiinput2;
        cin >> tiinput2;
        Sleep(1000);
        if (tiinput2 == 0) {
            cout << "레이더 조준 완료. SM-2 미사일을 발사합니다...\n";
            bool sm2hit1;
            sm2hit1 = hr_third;
            if (sm2hit1 == true) {
                cout << "적 정찰기를 격추했습니다.\n";
